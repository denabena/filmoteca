  ...
  return (
    <main className="flex flex-1 flex-col">
      ...
      */}
      ...
      <div className="rise-list flex flex-1 flex-col gap-[12px] px-4 pb-[14px] md:px-[40px]">
        {hero}
        {rail}
        <div
        ...
        >
          ...
          <div className="rise-list flex w-full flex-col items-stretch gap-[20px] xl:flex-row">
